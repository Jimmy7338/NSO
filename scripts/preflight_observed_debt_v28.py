...
from nso.observed_debt_v28 import build_context, rank_context, VERSION
...
OUT = ROOT/'audit_results/v28_descriptor_preflight_20260917'
PROTOCOL = ROOT/'docs/research/V28_DESCRIPTOR_PREFLIGHT_PROTOCOL_20260917.md'
...
def run():
    ...
    try:
        ...
        for p in (Path(__file__), PROTOCOL, ROOT/'tests/virtual3d/test_observed_debt_v28.py'):
