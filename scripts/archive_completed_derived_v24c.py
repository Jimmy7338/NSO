...
def require(n=0):
 ...
 if shutil.disk_usage(ROOT).free<n+65536:raise OSError('insufficient actually writable bavail space, preserving 64 KiB bootstrap slack')
def writejson(p,obj):
...
def prepare(folder,planpath):
 ...
 require(65536);folder.mkdir(parents=True)
