#!/usr/bin/env python3
"""Counterfactual shared score correction on recorded observed states only."""
import os
...
def main():
    ...
    try:
        ...
        for d in protocol['declarations']:
            ...
            row=dict(first_candidate_id=first,candidates=len(routes),old_scores=before['scores'],corrected_scores=scores,
