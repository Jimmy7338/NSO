...
def main(output, future_preparation):
    ...
    protocol = ROOT / "configs/virtual3d/semantic_gain_v11_1_confirmation2_protocol.json"
    contexts = ROOT / "configs/virtual3d/semantic_gain_v11_1_confirmation2_contexts.json"
    ...
    sources = [protocol, contexts, ROOT / "env/virtual3d_confirmation_v11_2.py",
        ROOT / "scripts/prepare_semantic_gain_v11_1_confirmation2.py",
    ...
    receipt = {"schema_version": "semantic_gain_v11_1_confirmation2_freeze/1",
