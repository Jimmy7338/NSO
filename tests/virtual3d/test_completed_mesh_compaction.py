...
SPEC = importlib.util.spec_from_file_location(
    'completed_mesh_compaction', Path(__file__).resolve().parents[2] / 'scripts/compact_completed_branch_meshes.py')
...
class CompactionEvidenceTest(unittest.TestCase):
    def setUp(self):
        ...
        self.audit.mkdir()
        self.mesh = 'P0/shelf_west/candidate_000/final_mesh.npz'
        self.raw = 'P0/shelf_west/prefix/frames/0000.npz'
    ...
    def test_unlisted_mesh_and_path_escape_are_rejected(self):
        bad = dict(self.manifest, **{'P0/shelf_west/unlisted/final_mesh.npz': 'd' * 64})
        with self.assertRaises(ValueError):
