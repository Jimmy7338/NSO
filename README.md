...
| G：几何完成 | 7.078693 | 7.132110 | 0.029558 |
| N：无类别 | 7.690027 | 7.741954 | 0.031061 |
| X：反转类别关联 | 4.820972 | 4.916976 | 0.019396 |

S相对G/N均值提高28.27%/18.07%；40个分支全部零碰撞并回到共享锚点，独立物理与指标重放40/40通过。该结论限于人工标记工业资产开发域，不代表Gibson/MP3D、自然开放词汇或TARE/FUEL等原作者系统结果。历史稿中的92.4%覆盖和11.9cm漂移没有可追溯实验，已从当前结论移除。
